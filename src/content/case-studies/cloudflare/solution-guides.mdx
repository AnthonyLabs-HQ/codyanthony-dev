...
description: Cross-product solution guides on Cloudflare docs. Cookbook-style workflows across multiple products, authored docs-as-code and completable on Free plans.
section: technical-documentation
order: 50
pdf:
  href: /Cody_Anthony_Sample_1_Solution_Guide_Stop_Malicious_Bots.pdf
  label: Download solution guide sample (PDF)
---
