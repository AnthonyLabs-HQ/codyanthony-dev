...
description: "VMware HCX migration guide for Amazon EVS: private and public connectivity paths, covering VPC, IPAM, Transit Gateway, Direct Connect, and Elastic IPs."
...
The guide addresses a dual-audience challenge: AWS architects need VMware HCX context, while VMware administrators need AWS networking guidance across VPC, Transit Gateway, AWS Direct Connect, Site-to-Site VPN, IPAM, and Elastic IP configuration. This work shipped with the EVS HCX public connectivity feature launch in Q3 2025.

## My role and ownership

I worked with EVS product and engineering teams throughout 2024 and 2025 to develop the migration guidance, performing cross-service research across AWS networking services and VMware HCX. The documentation strategy compared private and public connectivity options, surfaced Elastic IP association requirements upfront, and helped customers understand the tradeoffs before choosing a migration path.

## What the work solved

- **Connectivity choice.** Documented a public internet migration path for customers who did not have, or did not want to start with, dedicated private connectivity.
- **Architecture decision support.** Compared private and public connectivity options so customers could evaluate performance, cost, setup complexity, and security considerations before deployment.
- **Upfront requirement visibility.** Surfaced Elastic IP, IPAM, VLAN, routing, and network ACL requirements before customers began configuring HCX connectivity.

## What this sample demonstrates

- Cross-service technical research across VPC, IPAM, Transit Gateway, Direct Connect, Site-to-Site VPN, Elastic IPs, and VMware HCX
- Architecture tradeoff documentation that helps customers choose between private and public connectivity
- Public internet migration guidance with Elastic IP association procedures
- Security-aware networking documentation, including routing, network ACL, and public connectivity considerations
- Dual-audience writing that bridges AWS networking and VMware migration concepts
...
The complete HCX migration documentation includes VMware-specific configuration, private connectivity setup, public connectivity setup, and optional HCX features. This excerpt focuses on the architecture comparison, public internet connectivity model, Elastic IP association workflow, and AWS networking requirements to show the decision-support and cross-service research behind the guide.
